...
export default function HeroSection() {
    ...
    return(
                ...
                <motion.h1
                    ...
                    <motion.p
                        ...
                        transition={{ duration: 0.6, delay: 0.6}}>
                            Farm-to-cup single-origin beans from Ethopia, Colombia& beyond. Freshly
                        ...
                        transition={{ duration: 0.5, delay: 0.8 }}>
                            <Button
                                ...
                                size="lg"
                                onClick={() =>
                                    document.getElementById("about")?.acrollIntoView({ behavior: "smooth" })
                                }>
                                    OUR STORY
                                </Button>
                        </motion.div>
        ...
        <div className="hero-art-conatainer">
            <motion.img
                className="hero-art"
                src={heroBeans}
                ...
                <motion.div
                    ...
                    transition={{
                        ...
                        <span slassNamej="hero-floating-badge-price">$14.99</span>
